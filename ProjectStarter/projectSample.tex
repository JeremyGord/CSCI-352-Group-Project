...
\author{Jeremy Gordon\\ Partners name here% <-this % stops a space
}

\IEEEtitleabstractindextext{%
\begin{abstract}
Our project is a calender application. The target audience are individuals that need a calander and do not have one yet. 
\end{abstract}
