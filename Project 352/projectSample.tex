...
\section{Results}
Currently we have implemented the 3rd use case fully. We are currently in the process of finishing up use case one and two. 
We are behind schedule on implementing base goals two and three. Leaving us less time for the last base goal and the testing process.
